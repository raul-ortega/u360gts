...
const uint32_t baudRates[] = {0, 1200, 2400, 4800, 9600, 19200, 38400, 57600, 115200, 230400, 250000}; // see baudRate_e
...
#else
    cliCharCounter++;
    //if(cliCharCounter>3) cliCharCounter=1;
    if (receivedChar == 'R') {
    	cliCharCounterDetected++;
    	//printf("CC %u CCD %u",cliCharCounter,cliCharCounterDetected);
    	if(cliCharCounterDetected != cliCharCounter) {
    		cliCharCounter=1;

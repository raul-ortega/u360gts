...
void sendMavlinkGpsCoord() {
	...
	mavlink_msg_gps_raw_int_pack (100, 200, &msg, 0, gpsStatus, targetPosition.lat*10, targetPosition.lon*10, ((int32_t)targetPosition.alt)*1000, 0, 0, telemetry_speed, 0, (uint8_t)sats,0,0,0,0,0,0);

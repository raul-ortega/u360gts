...
typedef enum {
	...
	TRACKER_VALUE = (3 << VALUE_SECTION_OFFSET),
...
/*    { "rssi_ppm_invert",            VAR_INT8   | MASTER_VALUE | MODE_LOOKUP,  &masterConfig.rxConfig.rssi_ppm_invert, .config.lookup = { TABLE_OFF_ON } },
    ...
    { "servo_pwm_rate",             VAR_UINT16 | TRACKER_VALUE,  &masterConfig.servo_pwm_rate, .config.minmax = { 50,  498 } },
...
*/
#ifdef GPS
	{ "gps_baud",               	VAR_UINT8  | TRACKER_VALUE, &masterConfig.serialConfig.portConfigs[1].gps_baudrateIndex, .config.minmax = { BAUD_4800,  BAUD_250000 } },
    { "gps_provider",               VAR_UINT8  | TRACKER_VALUE | MODE_LOOKUP,  &masterConfig.gpsConfig.provider, .config.lookup = { TABLE_GPS_PROVIDER } },
    { "gps_sbas_mode",              VAR_UINT8  | TRACKER_VALUE | MODE_LOOKUP,  &masterConfig.gpsConfig.sbasMode, .config.lookup = { TABLE_GPS_SBAS_MODE } },
...
*/
	...
	{ "max_pid_error",           	VAR_UINT8  | TRACKER_VALUE, &masterConfig.max_pid_error, .config.minmax = { 0,  100 } },
	...
	{ "telemetry_protocol",        	VAR_UINT16 | TRACKER_VALUE, &masterConfig.telemetry_protocol, .config.minmax = { TP_SERVOTEST,  TP_LTM_FRSKYD } },

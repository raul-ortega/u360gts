...
void gpsInit(serialConfig_t *initialSerialConfig, gpsConfig_t *initialGpsConfig)
{
	...
	//gpsPort = openSerialPort(SERIAL_PORT_USART2, FUNCTION_GPS, NULL, BAUD_38400, mode, SERIAL_NOT_INVERTED);
    //gpsPort = openSerialPort(SERIAL_PORT_USART2, FUNCTION_GPS, NULL, serialConfig->portConfigs[0].gps_baudrateIndex, mode, SERIAL_NOT_INVERTED);
